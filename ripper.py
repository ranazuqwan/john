#!/usr/bin/python
# coding=utf-8
# Originally Written By:John the Ripper
# Source : Python2"
# Donot Recode It. 
...
\033[1;92m|   John       TRICKS
\033[1;92m| . Zakwan.      TRICKS
 \033[1;92m|  Zakwan.      TRICKS          
\033[1;97m-----------------------------------------------
\033[1;91m➣ OWNER   : Rana Zakwan      TRICKS
\033[1;91m➣ GANG    :  John the Ripper
\033[1;91m➣ Youtube : Rana Zuqwan
\033[1;91m➣ WhatsApp: +923216851651
\033[1;97m-----------------------------------------------"""
back = 0
threads = []
successful = []
...
def choice1_menu():
	...
	if c1m =="":
		...
		try:
			...
			MarwatTricks ("[✓] Account  Name: "+op["name"])
		...
		choice1_menu()
	rana = str(len(id))
	marwattricks ("[✓] Total Friends: "+rana)
	time.sleep(0.5)
	marwattricks ("[✓] The Process Has Been Started.")
	time.sleep(0.5)
	marwat ("[!] Press CTRL Z To Stop Process")
	time.sleep(0.5)
	print (47*"-")
	...
	p.map(main, id)
	print "\033[1;97m----------------------------------------------"
	marwattricks('[✓] Process Has Been Completed.')
	marwattricks('\033[1;97m[✓] Checkpoint IDS Has Been Saved.')
	xx = str(len(oks))
...
def choice2_menu():
	...
	marwattricks ("[✓] The Process Has Been Started.")
	time.sleep(0.5)
	marwattricks ("[!] Press CTRL Z To Stop Process.")
	time.sleep(0.5)
	print (47*"-")
